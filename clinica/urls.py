...
from .views import TurnoCreate, TurnoDelete, TurnoUpdate, TurnosYearArchiveView, TurnosMonthArchiveView, \
    TurnosDayArchiveView, TurnosListView
from . import views
...
urlpatterns = [
    ...
    path('turnos_archivo/<int:year>/<int:month>/', TurnosMonthArchiveView.as_view(month_format='%m'),
         name="turnos_month_numeric"),
